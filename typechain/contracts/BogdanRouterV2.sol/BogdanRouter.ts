...
export interface BogdanRouterInterface extends utils.Interface {
  functions: {
...
export type LiquidityEvent = TypedEvent<[BigNumber], LiquidityEventObject>;
...
export interface BogdanRouter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BogdanRouterInterface;
  ...
  filters: {
    ...
    "Liquidity(uint256)"(arg0?: null): LiquidityEventFilter;
    Liquidity(arg0?: null): LiquidityEventFilter;
